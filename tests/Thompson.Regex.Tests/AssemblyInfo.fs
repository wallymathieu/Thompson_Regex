...
[<assembly: AssemblyTitleAttribute("Thompson.Regex.Tests")>]
[<assembly: AssemblyProductAttribute("Thompson.Regex")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "Thompson.Regex.Tests"
    let [<Literal>] AssemblyProduct = "Thompson.Regex"
